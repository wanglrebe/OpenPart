# backend/app/api/routes.py (更新版本 - 添加导入导出路由)
...
from app.api.admin.import_export import router as import_export_router  # 新增
...
api_router.include_router(import_export_router, prefix="/admin/import-export", tags=["管理员-导入导出"])  # 新增
