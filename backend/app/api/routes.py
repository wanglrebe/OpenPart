# backend/app/api/routes.py (更新 - 添加对比路由)
...
from app.api.public.compare import router as compare_router  # 新增
...
api_router.include_router(compare_router, prefix="/public/compare", tags=["公开-对比"])  # 新增